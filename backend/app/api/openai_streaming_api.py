"""Streaming API using OpenAI Agents SDK"""
import logging
...
from app.agents.openai_agent_supervisor import get_openai_agent_supervisor
...
async def start_session(
    ...
    """Start a new transcription session using OpenAI Agents"""
    try:
        # Validate encounter
        ...
        supervisor = get_openai_agent_supervisor()
...
async def process_audio_chunk(
    ...
    """Process an audio chunk through the agent pipeline"""
    supervisor = get_openai_agent_supervisor()
